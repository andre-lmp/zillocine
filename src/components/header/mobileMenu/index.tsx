...
export default function MobileMenu({
  ...
  const changeMenuStyle = (pathname: string) => {
    ...
    mobileNavLinks.current &&
      mobileNavLinks.current.forEach((element) => {
  ...
  return (
    <div className="drawer">
      ...
      <div className="drawer-content z-40">{children}</div>
        ...
        <div className="w-72 text-gray-50 pb-5 font-medium text-lg flex flex-col font-noto_sans min-h-screen bg-deepnight">
          {!userData.isLoggedIn ? (
            ...
            <div className="px-4 pt-5 bg-deepnight">
              <button
                ...
                className="w-full font-medium text-white bg-orangered flex items-center justify-center text-[17px] h-12 rounded-3xl btn hover:bg-orangered border-none outline-none"
              >
                Criar conta
              </button>
              ...
              <button
                ...
                className="w-full font-medium text-white bg-darkpurple flex items-center justify-center text-[17px] h-12 rounded-3xl mt-2 btn hover:bg-darkpurple border-none outline-none"
              >
                Entrar
              </button>
            </div>
            ...
            <div
              ...
              className="w-full bg-deepnight pt-7 px-4 gap-x-3 flex items-center"
            >
          ...
          <ul className="text-[17px] lg:text-lg flex flex-col gap-y- *:flex *:pl-4 *:items-center *:gap-x-3">
            ...
            <li
              ...
              id="/"
              ref={(e) => {
                mobileNavLinks.current[0] = e;
              }}
              className="text-neutral-500 py-4"
            ...
            <li
              ...
              id="/favorites"
              ref={(e) => {
                mobileNavLinks.current[4] = e;
              }}
              className="-translate-x-0.5 text-neutral-500 py-4 hidden lg:inline"
              onClick={drawerToggle}
            >
            ...
            <li
              key="li-element-20"
              className="w-full mx-auto h-px bg-neutral-900 rounded-3xl my-4"
            ></li>
            ...
            {userData.isLoggedIn ? (
              <>
                <li
                  key="li-element-23"
                  className="w-full h-px bg-neutral-900 rounded-3xl my-4"
                ></li>
