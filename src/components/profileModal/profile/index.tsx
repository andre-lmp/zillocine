...
export default function Profile(props: ProfileProps) {
  ...
  const checkboxInputRef: MutableRefObject<HTMLInputElement | null> =
    useRef(null);
  ...
  return (
    <div className="w-full mx-auto flex flex-col justify-center items-center  p-7 relative">
        ...
        {uploadedImageUrl ? (
          ...
          <div className="flex gap-x-5 mt-5">
            <button
              ...
              className="btn bg-white/5 hover:bg-white/5 text-white px-4 rounded-lg font-normal text-base border-none outline-none"
            >
              Cancelar
            </button>
            ...
            <button
              ...
              className="btn bg-darkslateblue hover:bg-darkslateblue text-white px-4 rounded-lg font-normal text-base border-none outline-none"
            >
              Atualizar
            </button>
          </div>
      ...
      <p className="text-[17px] font-medium w-full text-left mt-10">
        *Nome de usuário
      </p>
      ...
      <div className="flex items-center justify-start font-medium border border-transparent outline-none text-[15px] text-neutral-400 mt-2 bg-richblack rounded h-12 px-3 w-full relative">
        ...
        <FaPencil
          onClick={() => {
            props.nextSlide("editName"), props.slideTo("next-slide");
          }}
      ...
      {userData.email ? (
        ...
        <>
          <p className="text-[17px] font-medium w-full text-left mt-4">
            *Email
          </p>
          ...
          <div className="flex items-center justify-start font-medium border border-transparent outline-none text-[15px] text-neutral-400 mt-2 bg-richblack rounded h-12 px-3 w-full relative">
            ...
            <FaPencil
              onClick={() => {
                props.nextSlide("editEmail"), props.slideTo("next-slide");
              }}
              className="absolute right-3 md:cursor-pointer"
            />
          </div>
